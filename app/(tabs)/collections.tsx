...
const styles = StyleSheet.create({ head: { flexDirection: 'row', justifyContent: 'space-between' }, add: { width: 46, height: 46, backgroundColor: colors.yellow, borderWidth: 1.5, borderColor: colors.yellow, borderRadius: 23, alignItems: 'center', justifyContent: 'center' }, grid: { flexDirection: 'row', flexWrap: 'wrap', gap: 13 }, new: { width: '48%', minHeight: 206, borderWidth: 1.5, borderStyle: 'dashed', borderColor: colors.purple, backgroundColor: colors.pinkSoft, borderRadius: radii.lg, alignItems: 'center', justifyContent: 'center', gap: 8 }, newText: { fontWeight: '800', color: colors.purpleDark }, overlay: { flex: 1, backgroundColor: 'rgba(33,21,43,.35)', justifyContent: 'flex-end' }, modal: { backgroundColor: colors.paper, padding: 24, paddingBottom: 38, borderTopLeftRadius: 28, borderTopRightRadius: 28, gap: 22 }, modalTitle: { fontSize: 28, fontWeight: '900', color: colors.purpleDark } });
