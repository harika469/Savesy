...
const styles = StyleSheet.create({ brandRow: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', marginBottom: 28 }, brand: { fontSize: 22, fontWeight: '900', letterSpacing: -.8 }, sectionRow: { marginTop: 30, marginBottom: 12, flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' }, section: { fontSize: 21, fontWeight: '900' }, small: { color: colors.gray, fontSize: 11 }, kicker: { fontSize: 11, letterSpacing: 1.6, fontWeight: '900' }, hero: { fontSize: 27, lineHeight: 31, fontWeight: '900', marginTop: 18, maxWidth: '90%' }, meta: { marginTop: 8, color: colors.gray }, actions: { flexDirection: 'row', gap: 10, marginTop: 25 }, notNow: { minHeight: 54, paddingHorizontal: 14, justifyContent: 'center' }, notNowText: { fontSize: 12, fontWeight: '900', textDecorationLine: 'underline' } });
