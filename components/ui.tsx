...
const styles = StyleSheet.create({
  ...
  search: { backgroundColor: colors.white, borderWidth: 1.5, borderColor: colors.ink, borderRadius: radii.md, minHeight: 52, paddingHorizontal: 15, flexDirection: 'row', alignItems: 'center', gap: 10 },
  searchInput: { flex: 1, fontSize: 16, color: colors.ink, paddingVertical: 12 },
  primary: { minHeight: 54, borderRadius: radii.md, backgroundColor: colors.ink, paddingHorizontal: 20, alignItems: 'center', justifyContent: 'center', flexDirection: 'row', gap: 9 },
  primaryText: { color: colors.white, fontSize: 14, fontWeight: '900', letterSpacing: .8 },
  chip: { minHeight: 40, paddingHorizontal: 15, borderRadius: 20, borderWidth: 1.5, borderColor: colors.ink, alignItems: 'center', justifyContent: 'center', backgroundColor: colors.paper },
  chipActive: { backgroundColor: colors.ink }, chipText: { fontSize: 12, fontWeight: '800' }, chipTextActive: { color: colors.white },
  fieldLabel: { fontSize: 12, fontWeight: '900', letterSpacing: 1, textTransform: 'uppercase' },
  input: { backgroundColor: colors.white, borderColor: colors.ink, borderWidth: 1.5, borderRadius: radii.md, minHeight: 52, paddingHorizontal: 15, paddingVertical: 13, fontSize: 15, color: colors.ink },
  card: { backgroundColor: colors.white, borderRadius: radii.lg, borderWidth: 1.5, borderColor: colors.ink, padding: 18, shadowColor: colors.ink, shadowOffset: { width: 3, height: 4 }, shadowOpacity: .1, shadowRadius: 0, elevation: 2 },
});
